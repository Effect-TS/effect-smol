...
const ModelIdsResponsesLiterals = [
  "o1-pro",
  "o1-pro-2025-03-19",
  "o3-pro",
  "o3-pro-2025-06-10",
...
export const ModelIdsShared = Schema.Union([
  Schema.String,
  Schema.Literals(ModelIdsSharedLiterals)
])

/**
 * @since 1.0.0
 */
export type ModelIdsShared = typeof ModelIdsSharedLiterals[number] | (string & {})
...
export const ModelIdsResponses = Schema.Union([
  ModelIdsShared,
  Schema.Literals(ModelIdsResponsesLiterals).annotate({ title: "ResponsesOnlyModel" })
])

/**
 * @since 1.0.0
 */
export type ModelIdsResponses = typeof ModelIdsResponsesLiterals[number] | ModelIdsShared
