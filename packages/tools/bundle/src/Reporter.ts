 ...
 * @category services
 */
export class Reporter extends ServiceMap.Service<Reporter>()("@effect/bundle/Reporter", {
  ...
  static layer = Layer.effect(this, this.make).pipe(Layer.provide(Fixtures.layer), Layer.provide(Rollup.layer))
}
