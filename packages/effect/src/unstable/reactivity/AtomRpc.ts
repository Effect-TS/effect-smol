...
export interface AtomRpcClient<Self, Id extends string, Rpcs extends Rpc.Any, E>
  extends ServiceMap.Service<Self, RpcClient.RpcClient.Flat<Rpcs, RpcClientError>>
{
  new(
    _: never
  ): ServiceMap.ServiceClass.Shape<Id, RpcClient.RpcClient.Flat<Rpcs, RpcClientError>>
