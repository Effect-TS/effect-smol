...
export const booleanPrimitive: Primitive<boolean> = makeSimplePrimitive(
	"Boolean",
	(value) => {
...
// String
export const stringPrimitive: Primitive<string> = makeSimplePrimitive(
	"String",
...
// Redacted
export const redactedPrimitive: Primitive<Redacted.Redacted<string>> =
	makeSimplePrimitive("Redacted", (value) =>
...
export const keyValueMapPrimitive: Primitive<Record<string, string>> =
	makeSimplePrimitive("KeyValueMap", (value) =>
		Effect.gen(function* () {
