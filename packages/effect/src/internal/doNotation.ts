...
export const bindTo = <F extends TypeLambda>(
  ...
  <N extends string>(name: N): <R, O, E, A>(self: Kind<F, R, O, E, A>) => Kind<F, R, O, E, Record<N, A>>
  <R, O, E, A, N extends string>(self: Kind<F, R, O, E, A>, name: N): Kind<F, R, O, E, Record<N, A>>
} =>
  dual(
    2,
    <R, O, E, A, N extends string>(self: Kind<F, R, O, E, A>, name: N): Kind<F, R, O, E, Record<N, A>> =>
