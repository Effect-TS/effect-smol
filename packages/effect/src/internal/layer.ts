...
const provideLayer = <A, E, R, ROut, E2, RIn>(
  ...
  effect.scopedWith((scope) =>
    effect.flatMap(Layer.buildWithScope(layer, scope), (context) => effect.provideServices(self, context))
  )
...
export const provide = dual<
  ...
  },
  {
    ...
    <A, E, R, R2>(self: Effect<A, E, R>, services: ServiceMap.ServiceMap<R2>): Effect<A, E, Exclude<R, R2>>
  }
>(
  2,
  <A, E, R, ROut>(
    self: Effect<A, E, R>,
    source: Layer.Layer<ROut, any, any> | ServiceMap.ServiceMap<ROut> | Array<Layer.Any>
