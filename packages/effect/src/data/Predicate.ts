 ...
 * ```ts
 * import * as assert from "node:assert"
 * import { isTupleOf } from "effect/data/Predicate"
 *
 ...
 * ```ts
 * import * as assert from "node:assert"
 * import { isTupleOfAtLeast } from "effect/data/Predicate"
 *
 ...
 * ```ts
 * import * as assert from "node:assert"
 * import { isTruthy } from "effect/data/Predicate"
 *
 ...
 * ```ts
 * import * as assert from "node:assert"
 * import { isSet } from "effect/data/Predicate"
 *
 ...
 * ```ts
 * import * as assert from "node:assert"
 * import { isMap } from "effect/data/Predicate"
 *
 ...
 * ```ts
 * import * as assert from "node:assert"
 * import { isNullish } from "effect/data/Predicate"
 *
 ...
 * ```ts
 * import * as assert from "node:assert"
 * import { isNotNullish } from "effect/data/Predicate"
 *
 ...
 * ```ts
 * import * as assert from "node:assert"
 * import { isPromise } from "effect/data/Predicate"
 *
 ...
 * ```ts
 * import * as assert from "node:assert"
 * import { isPromiseLike } from "effect/data/Predicate"
 *
