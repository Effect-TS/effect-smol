...
describe("Predicate", () => {
  ...
  it("isNullish", () => {
    assertTrue(Predicate.isNullish(null))
    assertTrue(Predicate.isNullish(undefined))
    assertFalse(Predicate.isNullish({}))
    assertFalse(Predicate.isNullish([]))
  })

  it("isNotNullish", () => {
    assertTrue(Predicate.isNotNullish({}))
    assertTrue(Predicate.isNotNullish([]))
    assertFalse(Predicate.isNotNullish(null))
    assertFalse(Predicate.isNotNullish(undefined))
  })
  ...
  it("isIterable", () => {
    ...
    assertTrue(Predicate.isIterable(new Map()))
