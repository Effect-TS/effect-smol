...
import { Brand, Cause, Chunk, Duration, Effect, Equal, HashSet, LogLevel, Option, pipe, Redacted } from "effect"
...
describe("Config", () => {
  describe("boolean", () => {
    it.only("name = undefined", () => {
      const config = Config.Array("ITEMS", { config: Config.Boolean() })
