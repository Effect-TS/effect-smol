...
describe("toJsonSchemaDocument", () => {
  ...
  describe("String", () => {
    ...
    it("String & custom check without annotation", () => {
      assertJsonSchemaDocument(Schema.String.check(Schema.makeFilter(() => true)), {
        schema: {
          type: "string"
        }
      })
    ...
    it("String & annotate & check", () => {
      assertJsonSchemaDocument(Schema.String.annotate({ description: "a" }).check(Schema.isMinLength(2)), {
        schema: {
          type: "string",
          description: "a",
          allOf: [{ minLength: 2 }]
    ...
    it("String & check & check", () => {
      assertJsonSchemaDocument(Schema.String.check(Schema.isMinLength(2), Schema.isMaxLength(3)), {
        schema: {
          type: "string",
    ...
    it("String & check & annotations & check & annotations", () => {
      assertJsonSchemaDocument(
        Schema.String.check(Schema.isMinLength(2, { description: "b" }), Schema.isMaxLength(3, { description: "c" })),
        {
          schema: {
            type: "string",
            allOf: [
    ...
    describe("checks", () => {
      ...
      describe("isLength", () => {
        it("String", () => {
          assertJsonSchemaDocument(Schema.String.check(Schema.isLength(2)), {
            schema: {
              type: "string",
        ...
        it("Array", () => {
          assertJsonSchemaDocument(Schema.Array(Schema.String).check(Schema.isLength(2)), {
            schema: {
              type: "array",
              items: {
                type: "string"
        ...
        it("NonEmptyArray", () => {
          assertJsonSchemaDocument(Schema.NonEmptyArray(Schema.String).check(Schema.isLength(2)), {
            schema: {
              type: "array",
              prefixItems: [
                {
      ...
      describe("isMinLength", () => {
        ...
        it("Array", () => {
          assertJsonSchemaDocument(Schema.Array(Schema.String).check(Schema.isMinLength(2)), {
            schema: {
              type: "array",
              items: {
                type: "string"
        ...
        it("NonEmptyArray", () => {
          assertJsonSchemaDocument(Schema.NonEmptyArray(Schema.String).check(Schema.isMinLength(2)), {
            schema: {
              type: "array",
              prefixItems: [
                {
      ...
      describe("isMaxLength", () => {
        ...
        it("Array", () => {
          assertJsonSchemaDocument(Schema.Array(Schema.String).check(Schema.isMaxLength(2)), {
            schema: {
              type: "array",
              items: {
                type: "string"
        ...
        it("NonEmptyArray", () => {
          assertJsonSchemaDocument(Schema.NonEmptyArray(Schema.String).check(Schema.isMaxLength(2)), {
            schema: {
              type: "array",
              minItems: 1,
              prefixItems: [
      ...
      it("isBase64", () => {
        assertJsonSchemaDocument(Schema.String.annotate({ description: "description" }).check(Schema.isBase64()), {
          schema: {
            type: "string",
            description: "description",
      ...
      it("isBase64Url", () => {
        assertJsonSchemaDocument(Schema.String.annotate({ description: "description" }).check(Schema.isBase64Url()), {
          schema: {
            type: "string",
            description: "description",
  ...
  describe("Finite", () => {
    ...
    describe("checks", () => {
      ...
      it("isUint32", () => {
        ...
        assertJsonSchemaDocument(Schema.Finite.check(Schema.isUint32({ description: "a" })), {
          schema: {
            type: "integer",
            allOf: [
              {
      ...
      it("isGreaterThanOrEqualTo", () => {
        assertJsonSchemaDocument(Schema.Finite.check(Schema.isGreaterThanOrEqualTo(1)), {
          schema: {
            type: "number",
            allOf: [{ minimum: 1 }]
          }
      ...
      it("isBetween", () => {
        assertJsonSchemaDocument(Schema.Finite.check(Schema.isBetween({ minimum: 1, maximum: 10 })), {
          schema: {
            type: "number",
        ...
        assertJsonSchemaDocument(
          Schema.Finite.check(Schema.isBetween({ minimum: 1, maximum: 10, exclusiveMinimum: true })),
          {
            schema: {
              type: "number",
        ...
        assertJsonSchemaDocument(
          Schema.Finite.check(Schema.isBetween({ minimum: 1, maximum: 10, exclusiveMaximum: true })),
          {
            schema: {
              type: "number",
  ...
  describe("Union of literals", () => {
    ...
    it("strings & inner annotate", () => {
      const schema = Schema.Union([Schema.Literal("a"), Schema.Literal("b").annotate({ description: "b-description" })])
      assertJsonSchemaDocument(schema, {
        schema: {
          anyOf: [
            {
        ...
        assertJsonSchemaDocument(
          ...
          }),
          {
            schema: {
              ...
              properties: {
                a: {
                  anyOf: [{ type: "string", description: "a" }, { $ref: "#/$defs/Undefined_" }]
                },
                b: {
                  anyOf: [{ type: "string" }, { $ref: "#/$defs/Undefined_" }],
                  description: "b"
                }
              },
              additionalProperties: false
          ...
          }),
          {
            schema: {
              ...
              properties: {
                ...
                b: {
                  anyOf: [{ type: "string", description: "b" }, { $ref: "#/$defs/Undefined_" }],
                  allOf: [
                    {
                      description: "b-key"
                    }
  ...
  describe("Record", () => {
    ...
    it("Record(`a${string}`, Number) & annotate", () => {
      assertJsonSchemaDocument(Schema.Record(Schema.TemplateLiteral(["a", Schema.String]), Schema.Finite), {
        schema: {
          type: "object",
          patternProperties: {
            "^a[\\s\\S]*?$": {
    ...
    it("Record(Literals(['a', 'b']), Number)", () => {
      assertJsonSchemaDocument(Schema.Record(Schema.Literals(["a", "b"]), Schema.Finite), {
        schema: {
          type: "object",
          properties: {
            a: { $ref: "#/$defs/Number_" },
    ...
    it("Record(isUppercased, Number)", () => {
      assertJsonSchemaDocument(Schema.Record(Schema.String.check(Schema.isUppercased()), Schema.Finite), {
        schema: {
          type: "object",
          patternProperties: {
            "^[^a-z]*$": {
    ...
    describe("checks", () => {
      it("isMinProperties", () => {
        assertJsonSchemaDocument(Schema.Record(Schema.String, Schema.Finite).check(Schema.isMinProperties(2)), {
          schema: {
            type: "object",
            additionalProperties: {
              type: "number"
      ...
      it("isMaxProperties", () => {
        assertJsonSchemaDocument(Schema.Record(Schema.String, Schema.Finite).check(Schema.isMaxProperties(2)), {
          schema: {
            type: "object",
      ...
      it("isPropertiesLength", () => {
        assertJsonSchemaDocument(Schema.Record(Schema.String, Schema.Finite).check(Schema.isPropertiesLength(2)), {
          schema: {
            type: "object",
            additionalProperties: { type: "number" },
    ...
    assertJsonSchemaDocument(
      ...
      ]),
      {
        schema: {
          ...
          additionalProperties: {
            anyOf: [{ type: "number" }, { $ref: "#/$defs/String_" }]
          },
          required: ["a"]
        },
        definitions: {
  ...
  describe("Tuple", () => {
    ...
    describe("required element", () => {
      ...
      it("String & annotate", () => {
        assertJsonSchemaDocument(Schema.Tuple([Schema.String.annotate({ description: "a" })]), {
          schema: {
            type: "array",
      ...
      it("String & annotateKey", () => {
        assertJsonSchemaDocument(Schema.Tuple([Schema.String.annotateKey({ description: "a-key" })]), {
          schema: {
            type: "array",
      ...
      it("String & annotate & annotateKey", () => {
        assertJsonSchemaDocument(
          Schema.Tuple([Schema.String.annotate({ description: "a" }).annotateKey({ description: "a-key" })]),
          {
            schema: {
              type: "array",
    ...
    describe("optionalKey", () => {
      it("String", () => {
        assertJsonSchemaDocument(Schema.Tuple([Schema.optionalKey(Schema.String)]), {
          schema: {
            type: "array",
            prefixItems: [{ type: "string" }],
            maxItems: 1
  ...
  describe("Array", () => {
    it("Array(String)", () => {
      ...
      assertJsonSchemaDocument(Schema.Array(Schema.String).annotate({ description: "a" }), {
        schema: {
          type: "array",
          items: { type: "string" },
          description: "a"
  ...
  it("TupleWithRest", () => {
    assertJsonSchemaDocument(Schema.TupleWithRest(Schema.Tuple([Schema.String]), [Schema.Finite]), {
      schema: {
        type: "array",
        prefixItems: [{ type: "string" }],
        items: { type: "number" },
  ...
  describe("Union", () => {
    ...
    it("String | Number", () => {
      ...
      assertJsonSchemaDocument(Schema.Union([Schema.String, Schema.Finite]).annotate({ description: "description" }), {
        schema: {
          anyOf: [{ type: "string" }, { type: "number" }],
          description: "description"
        }
