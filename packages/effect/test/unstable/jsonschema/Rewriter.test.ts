...
describe("Rewriter", () => {
  describe("openAi", () => {
    it("Root must be an object and not a union", () => {
      assertRewrite(Rewriter.openAi, Schema.String, {
        schema: {
          type: "object",
          properties: {},
          required: [],
      ...
      assertRewrite(Rewriter.openAi, Schema.Union([Schema.String, Schema.Number]), {
        schema: {
          type: "object",
          properties: {},
          required: [],
    ...
    describe("Suspend", () => {
      it("outer annotation", () => {
        ...
        assertRewrite(Rewriter.openAi, schema, {
          schema: {
            type: "object",
            properties: {
              a: {
    ...
    describe("Struct", () => {
      ...
      it("required field", () => {
        assertRewrite(Rewriter.openAi, Schema.Struct({ a: Schema.NonEmptyString }), {
          schema: {
            type: "object",
            properties: {
              a: {
      ...
      describe("optional field", () => {
        it("optionalKey", () => {
          assertRewrite(Rewriter.openAi, Schema.Struct({ a: Schema.optionalKey(Schema.String) }), {
            schema: {
              type: "object",
              properties: {
                a: { type: ["string", "null"] }
        ...
        it("optional", () => {
          assertRewrite(Rewriter.openAi, Schema.Struct({ a: Schema.optional(Schema.String) }), {
            schema: {
              type: "object",
              properties: {
                a: {
        ...
        it("UndefinedOr", () => {
          assertRewrite(Rewriter.openAi, Schema.Struct({ a: Schema.UndefinedOr(Schema.String) }), {
            schema: {
              type: "object",
              properties: {
                a: {
    ...
    it("String", () => {
      assertRewrite(Rewriter.openAi, Schema.Struct({ a: Schema.String.check(Schema.isMinLength(1)) }), {
        schema: {
          type: "object",
          properties: {
            a: {
    ...
    it("Tuple", () => {
      assertRewrite(Rewriter.openAi, Schema.Struct({ a: Schema.Tuple([Schema.NonEmptyString, Schema.Finite]) }), {
        schema: {
          type: "object",
          properties: {
            a: {
    ...
    it("Array", () => {
      assertRewrite(Rewriter.openAi, Schema.Struct({ a: Schema.Array(Schema.NonEmptyString) }), {
        schema: {
          type: "object",
          properties: {
            a: {
    ...
    it("UniqueArray", () => {
      assertRewrite(Rewriter.openAi, Schema.Struct({ a: Schema.UniqueArray(Schema.String) }), {
        schema: {
          type: "object",
          properties: {
            a: {
